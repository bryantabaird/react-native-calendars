  ...
  render() {
    ...
    return (
      <FlatList
        ...
        {...(this.props.renderListHeaderComponent ? {ListHeaderComponent: this.props.renderListHeaderComponent} : {})}
        {...(this.props.renderListHeaderComponentStyle ? {ListHeaderComponentStyle: this.props.renderListHeaderComponentStyle} : {})}
      />
    );
  }
}
